#!/usr/bin/env python3
"""Summarize short stability runs for four metadata_update online filter modes."""
...
BASE_DIR = Path(os.environ.get("STABILITY_OUT_DIR", ROOT / "out" / "alfresco_afl_metadata_online_filter_ablation_stability"))
...
SUMMARY_SOURCE = "afl_fuzz_metadata_online_filter_ablation_stability"
EXECUTION_SCOPE = "alfresco_metadata_update_mock_afl_online_filter_four_mode_short_stability"
METRIC_SEMANTICS = (
    "Short stability experiment over four metadata_update SE-fAnoGAN-ES-style online filter modes "
...
def fanogan_observation(
    ...
    if ae_execs and fanogan_execs < ae_execs:
...
def main() -> int:
    ...
    report = {
        ...
        "summary": summary_row,
        "boundary": [
            "metadata_update online filter four-mode short stability only",
