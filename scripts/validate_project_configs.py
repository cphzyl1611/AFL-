...
AFL_MUTATION_CHAIN_STABILITY_SUMMARIES = {
    Path("out/alfresco_afl_content_update_stability/stability_summary.csv"): {
        "runs",
        "total_execs_done",
        "total_valid_exec",
        "total_err_exec",
...
AFL_ONLINE_FILTER_SUMMARIES = {
    ...
    Path("out/alfresco_afl_metadata_online_filter_smoke_latest/summary.csv"): {
        "mode",
        "scenario",
        "nv_total_valid_exec",
        "nv_err_exec",
...
AFL_ONLINE_FILTER_ABLATION_SUMMARIES = {
    ...
    Path("out/alfresco_afl_metadata_online_filter_ablation/ablation_summary.csv"): {
        "scenario",
        "modes",
        "total_execs_done",
        "total_valid_exec",
    ...
    Path("out/alfresco_afl_multipart_online_filter_ablation/ablation_summary.csv"): {
        "scenario",
        "modes",
        "total_execs_done",
        "total_valid_exec",
...
AFL_ONLINE_FILTER_ABLATION_STABILITY_SUMMARIES = {
    ...
    Path("out/alfresco_afl_metadata_online_filter_ablation_stability/stability_summary.csv"): {
        "scenario",
        "modes",
        "runs_per_mode",
        "total_runs",
    ...
    Path("out/alfresco_afl_multipart_online_filter_ablation_stability/stability_summary.csv"): {
        "scenario",
        "modes",
        "runs_per_mode",
        "total_runs",
...
def check_summary_headers(state: ValidationState) -> None:
    ...
    for path, required in AFL_MUTATION_CHAIN_STABILITY_SUMMARIES.items():
        full = REPO_ROOT / path
        if not full.is_file():
