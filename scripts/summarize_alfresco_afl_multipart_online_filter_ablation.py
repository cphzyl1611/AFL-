#!/usr/bin/env python3
"""Summarize four-mode multipart_upload AFL++ online filter ablation evidence."""
...
BASE_DIR = Path(os.environ.get("ABLATION_OUT_DIR", ROOT / "out" / "alfresco_afl_multipart_online_filter_ablation"))
...
SUMMARY_SOURCE = "afl_fuzz_multipart_online_filter_ablation"
EXECUTION_SCOPE = "alfresco_multipart_upload_mock_afl_online_filter_four_mode_ablation"
METRIC_SEMANTICS = (
    "Multipart_upload four-mode SE-fAnoGAN-ES-style online filter ablation over representative AFL++ "
...
def main() -> int:
    ...
    summary_row = {
        ...
        "rule_only_filename_detected_count": int(by_mode["rule_only"]["filename_detected_count"]),
        "rule_ae_filename_detected_count": int(by_mode["rule_ae"]["filename_detected_count"]),
        "rule_fanogan_filename_detected_count": int(by_mode["rule_fanogan"]["filename_detected_count"]),
        "rule_ae_fanogan_filename_detected_count": int(by_mode["rule_ae_fanogan"]["filename_detected_count"]),
    ...
    report = {
        ...
        "summary": summary_row,
        "boundary": [
            "multipart_upload online filter four-mode ablation only",
            ...
            "not a four-mode short stability experiment",
